...
const I18N = {
  en: {
    ...
    'markets.title': 'Two markets. One mission.',
    'markets.lead': 'We pop up every week on the coast and in the mountains. Find us:',
    'markets.zonte.sub': 'Plaza Mango Verde · Bitcoin Beach',
    'markets.berlin.sub': 'The Standard · Usulután · in the mountains',
    'markets.day': 'Sunday',
    'markets.directions': 'Directions',
    'markets.note': '📅 Schedule rotates between locations — follow our X/Insta for the next pop-up date.',
    ...
    'connect.zonte':  'El Zonte location',
    'connect.berlin': 'Berlín location',
  ...
  es: {
    ...
    'markets.title': 'Dos mercados. Una misión.',
    'markets.lead': 'Cada semana en la costa y en la montaña. Encuéntranos en:',
    'markets.zonte.sub': 'Plaza Mango Verde · Bitcoin Beach',
    'markets.berlin.sub': 'The Standard · Usulután · en la montaña',
    'markets.day': 'Domingo',
    'markets.directions': 'Cómo llegar',
    'markets.note': '📅 La ubicación rota — síguenos en X/Insta para la próxima fecha.',
    ...
    'connect.zonte':  'Ubicación El Zonte',
    'connect.berlin': 'Ubicación Berlín',
